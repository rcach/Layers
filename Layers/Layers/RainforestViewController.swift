...
class RainforestViewController: UICollectionViewController, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
  ...
  override func collectionView(collectionView: UICollectionView, cellForItemAtIndexPath indexPath: NSIndexPath) -> UICollectionViewCell {
    ...
    if indexPath.item == 0 {
      ...
      cell.featureImageNode.image = UIImage(named: "a01")
      ...
      cell.featureImageNode.image = UIImage(named: "a02")
      ...
      cell.featureImageNode.image = UIImage(named: "a0\(indexPath.item)")
      ...
      cell.featureImageNode.image = UIImage(named: "a\(indexPath.item)")
      cell.backgroundImageNode.image = UIImage(named: "a\(indexPath.item)")
    }
    
//    cell.backgroundImageNode.hidden = true
//    cell.featureImageNode.hidden = true
//    cell.featureImageNode.setNeedsDisplayWithCompletion { cancelled in
//      if !cancelled {
//        cell.featureImageNode.hidden = false
//      }
//    }
...
//      }
//    }
    cell.contentNode.setNeedsLayout()
    cell.contentNode.preventOrCancelDisplay = false
    cell.contentNode.layer.setNeedsDisplay()
    return cell
  }
